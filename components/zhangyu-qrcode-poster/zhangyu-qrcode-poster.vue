	...
	export default{
		...
		data(){
			return {
				...
				ctx: null,
				isShow: false,
				qrcode: 'https://yoooho.bkbedu.com/poster/hch-code.jpg'
			}
		},
		methods:{
			//显示
			...
			async __init(){
				...
				hH = uni.upx2px(320);
				//绘制标题图
				this.drawRoundImg(this.ctx,headerImg.path,((this.canvasW-hH) / 2),((this.canvasW-hW) / 2),hH,hH,8)
				//绘制标题
				...
				this.ctx.setFillStyle('#858585');
				this.ctx.fillText('长按识别图中“Yoooho”小程序',30,(((this.canvasW-hW) / 2) + hH + 150))
				//底部广告
